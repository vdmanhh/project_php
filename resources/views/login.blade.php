...
<body class="bg-gradient-primary">
    <div style="padding-top: 40px;"><a href="{{route('home')}}" class="backs" style="cursor:pointer;color: white;font-weight:bold;font-size:20px; padding-left : 40px;padding-top:100px"><i class="fas fa-arrow-left mr-2"></i>Home</a></div>
    <div class="container">
