                    ...
                    <div class="hot-deal-wrapper">
                      <div class="image">
                        <a href="#">{
                          ...
                          <img src="{{asset('frontend/assets/images/hot-deals/p13_hover.jpg')}}" alt="" class="hover-image">
                        </a>
                      </div>
                    ...
                    <div class="cart clearfix animate-effect">
                      <div class="action">
                        <div class="add-cart-button btn-group">
                          ...
                          <button class="btn btn-primary cart-btn" type="button">Add to carttt</button>
                        </div>
                      </div>
                      <!-- /.action -->
                    </div>
                    ...
                    <div class="hot-deal-wrapper">
                      <div class="image">
                        <a href="#">
                          ...
                          <img src="{{asset('frontend/assets/images/hot-deals/p14_hover.jpg')}}" alt="" class="hover-image">
                        </a>
                      </div>
