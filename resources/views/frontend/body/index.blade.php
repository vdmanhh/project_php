                                            ...
                                            <div class="cart clearfix animate-effect">
                                                <div class="action">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="lnk wishlist"> <button type="button"id="{{$key->id}}" onclick="addToWishList(this.id)" data-toggle="tooltip" class="add-to-cart"  title="Wishlist"> <i class="icon fa fa-heart"></i> </button> </li>
