...
<div class="container-fluid ">
    <div class="row">
                        ...
                        <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn btn-info"><a class="abrands" href="{{route('state.edit',$key->id)}}">Edit</a></div>
                                        <div class="btn btn-danger "><a class="abrands deleted" href="{{route('state.delete',$key->id)}}">Delete</a></div>
                                    </td>
        ...
        <div class="col-4" style="background-color: white;border: 1px solid #e3e2e2;border-radius:10px; height:600px">
            <h3 class="text-primary" style="font-weight:bold;text-align: center;padding-top:20px">Add State</h3>
            <form method="post" action="{{route('add.state')}}" class="mt-3 mb-5" style="width: 80%; margin:auto">
                @csrf
                <div class="form-group">
                    <label for="exampleInputEmail1">State Name </label>
                    <input type="text" name="state_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name english">
	 ...
	 @enderror
                ...
                <div class="form-group">
                    ...
                    <select name="district_name" class="form-control" id="exampleFormControlSelect1">
                    <option >Choose District</option>
                        @foreach($districts as $cate)
                        <option value="{{$cate->id}}">{{$cate->district_name}}</option>
                        @endforeach
                    </select>
                </div>
